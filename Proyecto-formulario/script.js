...
function validarFormulario(){
    ...
    campoTexto.forEach(campo =>{
        let errorCampo = document.getElementById('error'+campo.id.charAt(0).toUpperCase() + campo.id.slice(1)) //error + id con la primer letra mayuscula y el resto minuscula
    ...
    return validacionCorrecta; //Si el formulario completo es valido devuelve TRUE
